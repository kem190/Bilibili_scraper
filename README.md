...
### **20240725**
随便做了一点初步的清理工作，发现确实值得做。所以说，之前不怎么做数据清理直接跑模型确实有点鲁莽了。现在一边清理一边记录一点好玩的事情吧。<br />
需要清理数据的时候，我首先想到了b站自动生成的数据，什么“目测要火，先马一下”，所以我的想法是删除重复的评论，毕竟这种生成的数据都长得一样，然而评论应该是每个人自己的观点。结果我发现，有专门复制粘贴的评论，虽然他们是跟主题相关的，因为有些人会复制一些评论到处发。<br />
![图12 重复评论](https://github.com/kem190/Bilibili_scraper/blob/main/rel_topics_k_12.jpeg](https://github.com/kem190/Bilibili_scraper/blob/main/%E9%87%8D%E5%A4%8D%E8%AF%84%E8%AE%BA.png)
所以能做的清理比较少。总之先清理了纯表情评论（'[doge]'这种的)：349405-345375。重复的评论仍然有49908条。有一些确实是有意义的，比如不同网友发的“坐等决赛”，有些则是不太有意义的，比如评论区养猫，或者评论区祝福。这评论区的猫还真挺可爱，但我也删不掉hhh。<br />
打算采取粗暴一点的办法，删掉字数少于二的先看看。因为三个字的我看到了“主主主”。所以删掉了空有at别人的，来到了336978，又删除了中文字符少于两个的，到了320209。重复评论认同感有37032条。<br />
继续检查这个重复评论，发现有一些评论似乎是at了其他视频，这种要保留么？保留吧，只把链接删掉。<br />
后面发现哪怕视频只有一条评论，我们也很难说它没有质量，所以就这样吧，保留哪怕只有一条评论的视频。<br />
按IP区分，wordfish了一下，不好看，不想继续调参了。我做了一个违背祖宗的决定：只要标题含有姜萍的视频的评论。这样一下从320277条变成108621条了。这决定也有一点点道理吧，在讨论中，我看到了很多讨论罗小黑之类的评论，所以有些视频可能是因为有个别人提到了姜萍就被包含进来了，也不合理。现在这样虽然鲁莽但是保证了纯洁性，大不了再人工筛选那几百个视频的标题好了。同时我还有一个发现，就是评论跟视频的主题的确有相对紧密的关系，所以引入一个不相关的视频就是引入了一坨垃圾。<br />
奇妙的河南网友，被程序归为怪人。是因为不管我们说什么，河南人都自己聊自己的吗？无论是三十多万评论还是十多万评论的数据都是如此，有趣的河南人。<br />
![图13 河南网友](https://github.com/kem190/Bilibili_scraper/blob/main/rel_topics_k_12.jpeg](https://github.com/kem190/Bilibili_scraper/blob/main/%E6%B2%B3%E5%8D%97%E7%BD%91%E5%8F%8B.jpeg)
但实际上，我还是没法发现词语的特点，相反，我根本理解不了分出来的词。明天换一个分词器看看，或者实在不行要慢慢微调词典了。到现在我突然也佛了，随便吧，爱什么结果出什么结果，爱出不出，这结果。<br />
