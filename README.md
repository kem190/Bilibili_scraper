...
接下来做了topic models，对此我首先遇到了划分文档的问题：之前是按community来划分，这几乎默认了b站推送和SNA这两者都有某种意义，但再观察后发现我们不应该如此认为。那么按照用户来划分文档显然过于细碎，但想按视频来划分则大概假设了同一个视频下的讨论大概是同质化的，这与经验不符。实际上，评论区的三条楼中楼可能能得出跟主评论完全相反的说法，或者至少是态度，这也许是topic models难以得出合理结果的原因。<br />
