...
# 信息填写栏
# API URL
comments_api_url = "https://api.bilibili.com/x/v2/reply/wbi/main?oid=1905878748&type=1&mode=3&pagination_str=%7B%22offset%22:%22%22%7D&plat=1&seek_rpid=&web_location=1315875&w_rid=e190eb10745b6448fa5ab1d7e90d5293&wts=1719747911"
...
def fetch_comments(api_url, headers, cookies, params, retries=3):
...
if all_data and all_data['code'] == 0:
    ...
    # 会返回错误的gen_url
    next_offset = all_data['data']['cursor']['session_id']
    print(next_offset)
    # id_next_page = re.findall('session_id\":(\d+)', all_data)[0]
    # print(id_next_page)
    pagination_str = f'{{"offset": {{"type": 1, "direction": 1, "session_id": "{next_offset}", "data": {{}}}}}}'
